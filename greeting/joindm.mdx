...
After this step the bot will automatically send the message to the users DM when they join the server.
You can test this message by running the following command:
```
/joindm test
```
