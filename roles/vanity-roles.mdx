...
<Warning>
This feature and its commands are powered by the [Miona Vanity](https://discord.com/oauth2/authorize?client_id=1280423090261725195) bot, so you must invite it to your server before using them.
</Warning>
...
- You must have [Miona Vanity](https://discord.com/oauth2/authorize?client_id=1280423090261725195) bot in your server
